...
public class Empresa {
    ...
    public void altaPuesto() {
        ...
        System.out.println("Ingrese los requerimientos para el puesto");
        ...
        switch (respuesta) {
            case 1:
                this.puestos.add(new PuestoJerarquico(descripcion, requerimientos));
                break;
            case 2:
    ...
    public void bajaPuesto() {
        ...
        // Todos los empleados que tengan asignado el puesto a eliminar.
        // Deberían quedar desasignados.
        puestoPorBorrar.eliminarEmpleados();
